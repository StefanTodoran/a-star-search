...
//     CompareStates(HeuristicFunction h) : heuristic(h) {}
...
//     std::cout << "\n\nStarting A* search with heuristic function\n";

//     SearchNode startState{start, {}};
//     std::set<GameState> visited;

//     int count = 0;
//     std::priority_queue<SearchNode, std::vector<SearchNode>, CompareStates> frontier((CompareStates(heuristic)));
